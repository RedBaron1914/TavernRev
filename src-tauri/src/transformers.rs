...
pub fn enforce_alternating_roles(messages: Vec<Message>) -> Vec<Message> {
    ...
    if let Some(first_idx) = merged.iter().position(|m| m.role != "system") {
        if merged[first_idx].role == "assistant" {
            merged.insert(first_idx, Message { role: "user".to_string(), content: "[Start Chat]".to_string(), name: None, images: None });
        }
    }
...
mod tests {
    ...
    fn test_merge_consecutive_roles() {
        let msgs = vec![
            Message { role: "system".to_string(), content: "Sys1".to_string(), name: None, images: None },
            Message { role: "system".to_string(), content: "Sys2".to_string(), name: None, images: None },
            Message { role: "user".to_string(), content: "Usr1".to_string(), name: None, images: None },
            Message { role: "user".to_string(), content: "Usr2".to_string(), name: None, images: None },
        ];
    ...
    fn test_enforce_alternating_roles() {
        let msgs = vec![
            Message { role: "system".to_string(), content: "S1".to_string(), name: None, images: None },
            Message { role: "assistant".to_string(), content: "A1".to_string(), name: None, images: None }, // Out of order!
            Message { role: "system".to_string(), content: "S2".to_string(), name: None, images: None },
            Message { role: "user".to_string(), content: "U1".to_string(), name: None, images: None },
        ];
