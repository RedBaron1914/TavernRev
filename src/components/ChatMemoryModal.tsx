      ...
      <div className="bg-gray-800 rounded-2xl w-full max-w-2xl border border-white/10 shadow-2xl flex flex-col h-[80vh]">
        <div className="p-4 border-b border-white/10 flex justify-between items-center shrink-0">
          <h3 className="font-bold flex items-center gap-2">
            <Sparkles size={18} className="text-amber-400" /> {t('chatMemoryNotes', 'Chat Memory & Notes')}
          </h3>
        ...
        <div className="flex-1 p-4 flex flex-col gap-2 min-h-0">
          <p className="text-xs text-gray-400 shrink-0">
            {t('writeContextRulesOrSummariesSpecificToThisChatThisTextIsAutomaticallyInjectedIntoTheSystemPrompt', 'Write context, rules, or summaries specific to this chat. This text is automatically injected into the System Prompt.')}
          </p>
          <textarea
            ...
            placeholder={t('egYouAreCurrentlyInTheWhisperingWoodsItIsRaining', 'E.g. You are currently in the Whispering Woods. It is raining...')}
            value={memory}
        ...
        <div className="p-4 border-t border-white/10 flex justify-between items-center bg-gray-900/30 rounded-b-2xl shrink-0">
          ...
          <div className="flex items-center gap-3">
              ...
              >
                <Save size={16} /> {t('saveMemory', 'Save Memory')}
              </button>
          </div>
        </div>
      </div>
